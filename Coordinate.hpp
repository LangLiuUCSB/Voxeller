...
struct Coordinate
{
  ...
  friend size_t manhattan_distance(const Coordinate &c1, const Coordinate &c2) noexcept
  {
  ...
  friend std::ostream &operator<<(std::ostream &s, const Coordinate &c) noexcept
  {
